...
const number = value => {
  if ((value.length === 11)&& (isNaN)) {
    return (
      <div className="alert alert-danger" role="alert">
        The length must be 10 and only numbers are allowed.
      </div>
    );
  }
};
...
const adhar = value => {
  if ((value.length === 15)&& (isNaN)) {
    return (
      <div className="alert alert-danger" role="alert">
        The length must be 15 and only numbers are allowed.
      </div>
    );
  }
};
  ...
  render() {
    return (
      <div className="col-md-12">
        <div className="card3 card-container">
        <div className="cardx">
          <img
